...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not handled:
        ...
        # Модели для xAI
        models_to_try = ["grok-beta"]  # Используйте доступные модели xAI; добавьте "grok-3-mini" если доступна
        response_text = "Извините, не удалось получить ответ от xAI API. Проверьте XAI_TOKEN и подписку."
        ...
        for model in models_to_try:
            try:
                ...
                response_text = "Ошибка авторизации: неверный XAI_TOKEN."
                break
            ...
            logger.error("Все модели недоступны. Проверьте XAI_TOKEN.")
            response_text = "Все модели недоступны. Обновите XAI_TOKEN."
